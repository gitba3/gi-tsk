...
const applicationsReducer = (state = initialState.applicationsReducer, action) => {
    switch(action.type) {
        case ActionType.GET_APPLICATIONS_RESPONSE: {
            ...
            return {
                ...state, 
                applications: _.assign(action.applications)
            };
        }
